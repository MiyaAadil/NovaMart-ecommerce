...
const Hero = () => {
  return (
    <div className='bg-slate-300 mx-auto mt-5 p-6 md:p-12 lg:p-16 flex flex-col-reverse md:flex-row items-center justify-between gap-10 rounded-2xl max-w-7xl'>
      ...
      {/* Right side content */}
      <div className='w-full md:w-1/2 flex justify-center items-center h-48 sm:h-64 md:h-80 lg:h-96 bg-slate-300 rounded-2xl p-4 overflow-hidden'>
        <img 
          className='h-full w-full rounded-2xl sm:rounded-xl object-contain object-center transform hover:scale-105 transition-transform duration-300' 
          src={KeyboardImage} 
